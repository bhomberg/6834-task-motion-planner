...
def putdown(x1,y1,x2,y2):
	...
	poseGen1.pose.position.z = table_height + .15
	poseGen1.gripperOpen = False

	# set down
	poseGen2 = pose_gen()
	poseGen2.pose.position.x = poseGen1.pose.position.x
	poseGen2.pose.position.y = poseGen1.pose.position.z
	poseGen2.pose.position.z = table_height + .03
	...
	# move out of the way
	poseGen6 = pose_gen()
	poseGen6.pose.position.z = table_height + .10
